...
$requete1 = "SELECT * FROM tarification 
        ...
        WHERE pension.Ville = 'Lambertsart'";
...
while ($donnees = $resultat->fetch()) {
    ...
    echo "Tarif : " .$donnees['tarif']."€". "<br>";
    echo "<a href='../modifier/modifier.php?id=".$donnees['id']."'><button>Modifier</button></a><br><br>";
    // afficher d'autres valeurs si nécessaire
}
...
<img src="../../img-user/lambersart.png">
<br><br>
<?php
